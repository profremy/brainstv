...
exports.showUserAlert = exports.hideUserAlert = void 0;

// SET ALERTS TO PROVIDE MEANINGFUL INFORMATION TO USERS
//type is 'success' or 'error'
var hideUserAlert = function hideUserAlert() {
  var el = document.querySelector('.alert');
  if (el) el.parentElement.removeChild(el);
};

exports.hideUserAlert = hideUserAlert;

var showUserAlert = function showUserAlert(type, msg) {
  hideUserAlert(); // const markup = `<div class="alert alert--${type}">${msg}</div>`;

  var markup = "<div class=\"alert alert--".concat(type, " alert-dismissible fade show rounded-0\" role=\"alert\">").concat(msg, "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>");
  document.querySelector('.clientSideAlerts').insertAdjacentHTML('afterbegin', markup); // document.querySelector('body').insertAdjacentHTML('afterbegin', markup);

  window.setTimeout(hideUserAlert, 5000);
};

exports.showUserAlert = showUserAlert;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showUserAlert)('success', 'Logged in successfully!');
          ...
          case 7:
            ...
            (0, _alerts.showUserAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showUserAlert)('error', 'Error logging out! Try again.');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"userAccountSettings.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showUserAlert)('success', "".concat(type.toUpperCase(), " updated successfully!"));
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var createUserRecord = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            _context2.prev = 8;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showUserAlert)('error', _context2.t0.response.data.message);
  ...
  return function createUserRecord(_x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
...
var sendPasswordResetLink = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            url = type === 'reset' ? '/clubmembers/forgotPassword' : '';
            _context3.next = 4;
            return (0, _axios.default)({
              method: 'POST',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showUserAlert)('success', "".concat(type.toUpperCase(), " password link sent successfully!"));
          ...
          case 8:
            ...
            (0, _alerts.showUserAlert)('error', 'An error occurred. Email not sent!');
  ...
  return function sendPasswordResetLink(_x6, _x7) {
...
var clubmemberPasswordReset = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            url = type === 'passwordReset' ? "/clubmembers/clubmemberPasswordReset/".concat(token) : '';
            _context4.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showUserAlert)('success', "".concat(type.toUpperCase(), " was successfully! Please log in again."));
          ...
          case 9:
            ...
            (0, _alerts.showUserAlert)('error', 'Token is invalid or has expired');
  ...
  return function clubmemberPasswordReset(_x8, _x9) {
...
var _userAccountSettings = require("./userAccountSettings");
...
}
{
  ...
  if (elements.userOptionsId) {
    elements.userOptionsId.addEventListener('click', function (e) {
      var userOptionsId = e.target.closest('#userOptions');
...
}
{
  ...
  if (elements.logOutBtn) elements.logOutBtn.addEventListener('click', _login.logout);
}
{
  ...
  if (elements.userPasswordForm) elements.userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _userAccountSettings.updateSettings)({
...
}
{
  ...
  var resetPassWord = document.querySelector('.forgottenpassword');
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return (0, _userAccountSettings.sendPasswordResetLink)({
                  email: email
                }, 'reset');
...
}
{
  ...
  var processPasswordReset = document.getElementById('formPasswordReset');

  if (processPasswordReset) {
    processPasswordReset.addEventListener('submit', /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 6;
                return (0, _userAccountSettings.clubmemberPasswordReset)({
                  password: password,
                  confirmPassword: confirmPassword
                }, 'passwordReset');
...
}
{
  ...
  if (homeWorkUploadForm) {
    homeWorkUploadForm.addEventListener('submit', /*#__PURE__*/function () {
            ...
            switch (_context6.prev = _context6.next) {
              case 0:
                if (homeWorkUploadFile.value === '') {
                  message = 'This is unusual, there is no file to Upload!';
                  (0, _alerts.showUserAlert)('error', message);
                  e.preventDefault();
                }
...
}
{
  ...
  var whenCanYouStopPollForm = document.getElementById('vote-whenCanYouStop-form');

  if (whenCanYouStopPollForm) {
    whenCanYouStopPollForm.addEventListener('submit', function (e) {
      e.preventDefault();
      ...
      var choice = document.querySelector('input[name=whenCanYouStop]:checked').value;
      var data = {
  ...
  fetch('/poll/whenCanYouStop').then(function (res) {
    return res.json();
  }).then(function (data) {
    //console.log(data);
    var votes = data.whenCanYouStop;
    var totalVotes = votes.length; // Count vote points -  acc/current

    var voteCounts = votes.reduce(function (acc, vote) {
      return acc[vote.whenCanYouStop] = (acc[vote.whenCanYouStop] || 0) + vote.points, acc;
    }, {});
    var dataPoints = [{
      label: 'YES',
      y: voteCounts.YES
    ...
    var whenCanYouStopResultContainer = document.getElementById('whenCanYouStopResultContainer');

    if (whenCanYouStopResultContainer) {
      var chart = new CanvasJS.Chart('whenCanYouStopResultContainer', {
        animationEnabled: true,
        theme: 'theme1',
        title: {
          text: "Total Votes: ".concat(totalVotes)
  ...
  if (elements.btnCheck && elements.checkBox) {
    window.addEventListener('load', function () {
      ...
      elements.checkBox.addEventListener('change', function () {
        ...
        if (checkboxCheck) {
          elements.btnCheck.disabled = false; //console.log('checked');
        } else {
          elements.btnCheck.disabled = true; //console.log('unchecked');
        }
      });
    });
  }
...

{
  ...
  setTimeout(function () {
    var timeDifference;
    var timeUserClosedMsg = localStorage.getItem('timeUserClosedMsg');
    ...
    if (!timeUserClosedMsg) {
      ...
      var timeout = timeDifference / 1000 / 60 / 60; //console.log(timeout);
  ...
  var popupMsgCloseBtnArr = document.querySelectorAll('.popupMsgClose');
  var popupMsgCloseBtn = Array.from(popupMsgCloseBtnArr);
  elements.app.addEventListener('click', function (e) {
    var closeBtn = e.target.closest('.popupMsgClose');

    if (closeBtn) {
      var _iterator = _createForOfIteratorHelper(popupMsgCloseBtn),
          _step;
...
}
{
  ...
  var updateButtonIcon = function updateButtonIcon(btnIcon) {
    var moreBtn = 'add-circle';
    var lessBtn = 'remove-circle';
    var viewMoreText = document.querySelector('.viewMoreText');
  ...
  var mpqListHidden = document.querySelectorAll('.js__hide');
  var mpqListHiddenArr = Array.from(mpqListHidden);
  var viewMoreButtonIcon = document.querySelector('.viewMore__btn__icon');
  elements.app.addEventListener('click', function (e) {
    var moreBtn = e.target.closest('.viewMore__btn__icon');

    if (moreBtn) {
      var _iterator2 = _createForOfIteratorHelper(mpqListHiddenArr),
          _step2;
...
}
{
  ...
  var updateIconBtn = function updateIconBtn(btn, attr) {
    var moreBtn = 'fa fa-plus-circle icon__btn'; // let moreBtn = 'add-circle-outline';

    var lessBtn = 'fa fa-minus-circle icon__btn'; // let lessBtn = 'remove-circle-outline';

    if (attr === moreBtn) {
      btn.setAttribute('class', lessBtn); // btn.setAttribute('name', lessBtn);
    } else {
      btn.setAttribute('class', moreBtn); // btn.setAttribute('name', moreBtn);
    }
  };

  var mpq = document.querySelector('.mpq');
  elements.app.addEventListener('click', function (e) {
    // console.log(e.target);
    // console.log(e.target.parentNode.parentNode.childNodes[3]);
    var targetBtn = e.target.closest('.icon__btn');

    if (targetBtn) {
      var attribute = targetBtn.getAttribute('class'); //console.log(attribute);
      // const attribute = targetBtn.getAttribute('name');

      var answer = targetBtn.parentNode.parentNode.childNodes[3];
...
}
{
  ...
  elements.app.addEventListener('click', function (e) {
    var createBtn = e.target.closest('#loader');
...
}
{
  ...
  var greeting = function greeting(firstname) {
    var date = new Date();
    var hours = date.getHours();
    var message = hours < 12 ? 'Good Morning' : hours < 18 ? 'Good Afternoon' : 'Good Evening';

    if (firstname !== '') {
      fname.textContent = "".concat(message, " ").concat(firstname, ",");
    } else {
      fname.textContent = "".concat(message, ",");
    }
  };

  elements.app.addEventListener('click', function (e) {
    var targetBtn = e.target.closest('#switch-list-moreInfo');
  ...
  var simulateClick = function simulateClick(idString) {
    var event = new MouseEvent('click', {
      view: window,
      bubbles: true,
      cancelable: true
    });
    var switchSection = document.getElementById("".concat(idString));
  ...
  elements.app.addEventListener('click', function (e) {
    ...
    if (e.target.hasAttribute('id')) {
      targetLink = e.target.getAttribute('id'); // const targetLink = e.target.getAttribute('id');

      if (targetLink.hasOwnProperty('length')) {
        var extraChar = targetLink.length - 7; //switchId = targetLink.slice(0, `-${extraChar}`); // "switch-"
        //const remainingId = targetLink.slice(`-${extraChar}`);

        var remainingId = targetLink.slice("-".concat(extraChar)); //console.log(remainingId);
        // console.log(remainingId);

        var remainderzero = remainingId[0]; // console.log(remainderzero);

        if (remainingId[0] === '2') {
          //console.log(remainingId.slice(1));
          var id = remainingId.slice(1);
          var idString = id + '-list'; //console.log(idString);
...
}
{
  ...
  document.querySelector(DOMStrings.jsCloseGdpr).addEventListener('click', function () {
